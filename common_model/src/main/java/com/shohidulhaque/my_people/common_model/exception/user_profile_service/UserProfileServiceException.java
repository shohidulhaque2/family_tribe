...
@Data
public class UserProfileServiceException extends ServiceException {
    ...
    public UserProfileServiceException(String message, Throwable cause, boolean enableSuppression,
