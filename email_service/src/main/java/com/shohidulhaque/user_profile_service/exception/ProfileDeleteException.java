...
public class ProfileDeleteException extends UserProfileServiceException {
    ...
    public ProfileDeleteException(String message, Throwable cause, boolean enableSuppression,
