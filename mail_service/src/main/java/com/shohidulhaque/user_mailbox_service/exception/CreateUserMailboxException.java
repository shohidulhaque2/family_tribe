...
public class CreateUserMailboxException extends UserMailboxServiceException {

    public CreateUserMailboxException(
        ResponseType responseType,
        ErrorType errorType) {
        super(responseType, errorType);
    }

    public CreateUserMailboxException(String message,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, responseType, errorType);
    }

    public CreateUserMailboxException(String message, Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, cause, responseType, errorType);
    }

    public CreateUserMailboxException(Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(cause, responseType, errorType);
    }

    public CreateUserMailboxException(String message, Throwable cause, boolean enableSuppression,
