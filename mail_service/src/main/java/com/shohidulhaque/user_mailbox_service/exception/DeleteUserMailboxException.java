...
public class DeleteUserMailboxException extends UserMailboxServiceException {


    public DeleteUserMailboxException(
        ResponseType responseType,
        ErrorType errorType) {
        super(responseType, errorType);
    }

    public DeleteUserMailboxException(String message,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, responseType, errorType);
    }

    public DeleteUserMailboxException(String message, Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, cause, responseType, errorType);
    }

    public DeleteUserMailboxException(Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(cause, responseType, errorType);
    }

    public DeleteUserMailboxException(String message, Throwable cause, boolean enableSuppression,
