...
public class UpdateUserMailboxException extends UserMailboxServiceException {

    public UpdateUserMailboxException(
        ResponseType responseType,
        ErrorType errorType) {
        super(responseType, errorType);
    }

    public UpdateUserMailboxException(String message,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, responseType, errorType);
    }

    public UpdateUserMailboxException(String message, Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, cause, responseType, errorType);
    }

    public UpdateUserMailboxException(Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(cause, responseType, errorType);
    }

    public UpdateUserMailboxException(String message, Throwable cause, boolean enableSuppression,
