...
public class ProfileCreateException extends UserProfileServiceException {
    ...
    public ProfileCreateException(String message, Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, cause, responseType, errorType);
    }

    public ProfileCreateException(Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(cause, responseType, errorType);
    }

    public ProfileCreateException(String message, Throwable cause, boolean enableSuppression,
