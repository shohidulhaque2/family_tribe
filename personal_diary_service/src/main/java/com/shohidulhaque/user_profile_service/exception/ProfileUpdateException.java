...
public class ProfileUpdateException extends UserProfileServiceException {
    ...
    public ProfileUpdateException(String message, Throwable cause, boolean enableSuppression,
