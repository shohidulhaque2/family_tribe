...
public class UserRegistryCreateServiceException extends UserRegistryServiceException {

    public UserRegistryCreateServiceException(
        ResponseType responseType,
        ErrorType errorType) {
        super(responseType, errorType);
    }

    public UserRegistryCreateServiceException(String message,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, responseType, errorType);
    }

    public UserRegistryCreateServiceException(String message, Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, cause, responseType, errorType);
    }

    public UserRegistryCreateServiceException(Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(cause, responseType, errorType);
    }

    public UserRegistryCreateServiceException(String message, Throwable cause, boolean enableSuppression,
