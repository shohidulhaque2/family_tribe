...
public class UserRegistryDeleteServiceException extends UserRegistryServiceException {


    public UserRegistryDeleteServiceException(
        ResponseType responseType,
        ErrorType errorType) {
        super(responseType, errorType);
    }

    public UserRegistryDeleteServiceException(String message,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, responseType, errorType);
    }

    public UserRegistryDeleteServiceException(String message, Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, cause, responseType, errorType);
    }

    public UserRegistryDeleteServiceException(Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(cause, responseType, errorType);
    }

    public UserRegistryDeleteServiceException(String message, Throwable cause, boolean enableSuppression,
