...
public class UserRegistryEmailAlreadyExistException extends UserRegistryServiceValidationException {

  public UserRegistryEmailAlreadyExistException(
  ...
  public UserRegistryEmailAlreadyExistException(String message,
      ResponseType responseType,
      ErrorType errorType,
      Collection<ConstraintViolation<PersonRegistrationDtoRequest>> violations,
      PersonRegistrationDtoRequest personRegistrationDtoRequest) {
  ...
  public UserRegistryEmailAlreadyExistException(String message, Throwable cause,
      ResponseType responseType,
      ErrorType errorType,
      Collection<ConstraintViolation<PersonRegistrationDtoRequest>> violations,
      PersonRegistrationDtoRequest personRegistrationDtoRequest) {
  ...
  public UserRegistryEmailAlreadyExistException(Throwable cause,
      ResponseType responseType,
      ErrorType errorType,
      Collection<ConstraintViolation<PersonRegistrationDtoRequest>> violations,
      PersonRegistrationDtoRequest personRegistrationDtoRequest) {
