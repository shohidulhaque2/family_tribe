...
public class UserRegistryGetServiceException extends UserRegistryServiceException {

    public UserRegistryGetServiceException(
        ResponseType responseType,
        ErrorType errorType) {
        super(responseType, errorType);
    }

    public UserRegistryGetServiceException(String message,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, responseType, errorType);
    }

    public UserRegistryGetServiceException(String message, Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(message, cause, responseType, errorType);
    }

    public UserRegistryGetServiceException(Throwable cause,
        ResponseType responseType,
        ErrorType errorType) {
        super(cause, responseType, errorType);
    }

    public UserRegistryGetServiceException(String message, Throwable cause, boolean enableSuppression,
