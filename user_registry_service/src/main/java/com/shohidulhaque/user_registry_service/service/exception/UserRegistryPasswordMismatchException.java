...
public class UserRegistryPasswordMismatchException extends UserRegistryServiceValidationException {

    public UserRegistryPasswordMismatchException(
    ...
    public UserRegistryPasswordMismatchException(String message,
        ResponseType responseType,
        ErrorType errorType,
        Collection<ConstraintViolation<PersonRegistrationDtoRequest>> violations,
        PersonRegistrationDtoRequest personRegistrationDtoRequest) {
    ...
    public UserRegistryPasswordMismatchException(String message, Throwable cause,
        ResponseType responseType,
        ErrorType errorType,
        Collection<ConstraintViolation<PersonRegistrationDtoRequest>> violations,
        PersonRegistrationDtoRequest personRegistrationDtoRequest) {
    ...
    public UserRegistryPasswordMismatchException(Throwable cause,
        ResponseType responseType,
        ErrorType errorType,
        Collection<ConstraintViolation<PersonRegistrationDtoRequest>> violations,
        PersonRegistrationDtoRequest personRegistrationDtoRequest) {
