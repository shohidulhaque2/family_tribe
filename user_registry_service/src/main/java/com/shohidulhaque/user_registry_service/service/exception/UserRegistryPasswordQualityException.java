...
public class UserRegistryPasswordQualityException extends UserRegistryServiceValidationException {

  public UserRegistryPasswordQualityException(
  ...
  public UserRegistryPasswordQualityException(String message,
      ResponseType responseType,
      ErrorType errorType,
      Collection<ConstraintViolation<PersonRegistrationDtoRequest>> violations,
      PersonRegistrationDtoRequest personRegistrationDtoRequest) {
  ...
  public UserRegistryPasswordQualityException(String message, Throwable cause,
      ResponseType responseType,
      ErrorType errorType,
      Collection<ConstraintViolation<PersonRegistrationDtoRequest>> violations,
      PersonRegistrationDtoRequest personRegistrationDtoRequest) {
  ...
  public UserRegistryPasswordQualityException(Throwable cause,
      ResponseType responseType,
      ErrorType errorType,
      Collection<ConstraintViolation<PersonRegistrationDtoRequest>> violations,
      PersonRegistrationDtoRequest personRegistrationDtoRequest) {
